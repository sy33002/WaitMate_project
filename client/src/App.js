  ...
  return (
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/proxy/register' element={<Template><ProxyRegister /></Template>}></Route>
        <Route path='/proxy/getter' element={<Template><ProxyList /></Template>}></Route>
        <Route path='/proxy/:proxyId' element={<Template><ProxyDetail /></Template>}></Route>
        <Route path='/waitMate/' element={<Template><WaitMateRegister /></Template>}></Route>
        <Route path='/waitMate/list' element={<Template><WaitMateList /></Template>}></Route>
        <Route path='/waitMate/detail' element={<Template><WaitMateDetail /></Template>}></Route>
