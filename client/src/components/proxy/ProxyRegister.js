...
export default function ProxyRegister() {
  ...
  const [imageFile, setImageFile] = useState(
    'https://sesac-projects.site/waitmate/images/proxy.png'
  );
          ...
          >
            ...
            >
              <div className="w-full h-full bg-background p-2 rounded-lg">
                {imageFile && (
                  <img src={imageFile} alt="Preview" className="w-full h-48" />
                )}
              </div>
            ...
            <div className={`${isSmallScreen ? 'w-full' : 'w-2/3 pl-4'}`}>
              ...
              <div>
                ...
                <button
                  ...
                  } bg-green p-1 font-Line rounded-lg mb-1`}
                >
                  주소 검색
                </button>{' '}
                <br />
                <span
                  className={`${
                    isSmallScreen ? 'text-[8px]' : 'text-xs'
                  } text-red-300  font-Line pl-1`}
                >
